  ...
  *device_name = 0;
  ...
  if (File)
  {
    ...
    while ((result = my_getline(File, name, sizeof(name), value, sizeof(value))) != 0)
    {
      ...
      if (strcasecmp(name,"failed_copy")==0)
      ...
      if (strcasecmp(name,"report_copy")==0)
      ...
      if (strcasecmp(name,"sent_copy")==0)
      ...
      if (strcasecmp(name,"sleeptime_mainprocess")==0)
        sleeptime_mainprocess=atoi(ask_value(0, name, value));
      else
      if (strcasecmp(name,"check_pid_interval")==0)
	...
	autosplit=atoi(ask_value(0, name, value));
      ...
      if (strcasecmp(name,"child_args")==0)
        strcpy2(mainprocess_child_args, ask_value(0, name, value));
      else
      if (strcasecmp(name,"eventhandler_use_copy")==0)
      {
...
int startup_check(int result)
{
  ...
  if (*mainprocess_child && executable_check)
  {
    ...
    {
      fclose(fp);
      if (!is_executable(mainprocess_child))
        wrlogfile(&result, "Child %s is not executable for smsd.", mainprocess_child);
    }
  }
